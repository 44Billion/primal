...
import { batch, Component, createEffect, createSignal, on, Show } from 'solid-js';
...
const ArticlePreviewPhone: Component<{
  id?: string,
      ...
      <div class={styles.stats}>
        <div class={styles.estimates}>
          ...
          <div class={styles.estimate}>
            ...
            {Math.ceil(props.article.replies)} comments
          </div>
        </div>
...
export default hookForDev(ArticlePreviewPhone);
